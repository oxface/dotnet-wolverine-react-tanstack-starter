...
- `capabilities/add-keycloak-auth.mjs` adds Keycloak OIDC, ASP.NET Core cookie auth, and a Redis-backed persistent ticket store. Run through `pnpm starter:add-auth-keycloak`.
